...
export const webDevelopmentEn: ServicePageData = {
  ...
  packages: [
    {
      ...
      price: "$200",
      description: "Ideal for product launches, paid ad campaigns, and focused service offerings.",
      features: [
        "1 Responsive Conversion Landing Page",
        "Sub-Second Load Speed (< 1s)",
        "Direct WhatsApp & Contact Form",
        "Free 1-Year Domain & Cloud Hosting",
        "SEO Baseline & Google Analytics",
    ...
    },
    {
      ...
      price: "$450",
      isPopular: true,
      description: "Comprehensive solution for growing companies and B2B brand credibility.",
      features: [
        "5-7 Custom Content Pages",
        "Interactive Blog & Portfolio CMS",
        "Pro SEO Architecture + Schema Markup",
        "Lead Capture & Inquiry Funnel",
        "Free 1-Year Domain & Cloud Hosting",
        "3-Month Bug-Free Warranty",
    ...
    },
    {
      ...
      price: "$950+",
      description: "For enterprises needing deep system integrations, client portals, or multi-language support.",
      features: [
        "Scalable Custom Page Count",
        "Bespoke Framework (Next.js / Astro)",
        "Multi-language (EN & ID) Support",
        "Internal API & Database Integration",
        "Security Audit & High-Traffic CDN",
        "Full Git Repository Transfer",
        "6-Month Dedicated SLA & Warranty",
        "2-4 Weeks Delivery"
      ]
    }
  ],
  techStackTitle: "Modern Tech Stack",
  techStackSubtitle: "Modern architecture built for speed and security without the bloat of traditional CMS plugins.",
  techStack: [
    { name: "Next.js & Astro", category: "Frontend Framework", description: "Instant rendering, top SEO authority, and lightweight bandwidth." },
    { name: "Tailwind CSS", category: "Styling System", description: "Clean, consistent, and maintainable styles across screens." },
  ...
  faqs: [
    {
      ...
      answer: "A landing page is completed in 3-5 business days, a corporate company profile in 7-10 days, and custom portal solutions in 2-4 weeks depending on scope."
    },
    {
      question: "Are hosting and domain included?",
      answer: "Yes, all our packages include domain registration (.com / .id) and high-speed cloud hosting for the first year."
    },
    {
      question: "Can our team update content after launch?",
      answer: "Absolutely. We configure an intuitive CMS dashboard and provide short video guides so your staff can update content easily without technical background."
    },
    {
      question: "How is SEO optimized for Google rankings?",
      answer: "All websites are built with semantic HTML5, structured meta tags, XML sitemaps, JSON-LD schema markup, and optimized Core Web Vitals scores."
    },
    {
