...
1. **Clarity** — Users should know exactly what happens when they click (*"Start Free Trial"* beats *"Submit"*)
2. **Contrast** — The button must stand out from the surrounding elements
3. **Proximity** — Place CTAs close to the content that justifies the action
